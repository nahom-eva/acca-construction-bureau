...
export const SUB_CITIES: SubCity[] = [
  ...
  { id: 'sc_dabe',    name: 'Dabe' },
  { id: 'sc_lugo',    name: 'Lugo' },
  { id: 'sc_bole',    name: 'Bole' },
  { id: 'sc_abageda', name: 'Aba-geda' },
];
...
export const WEREDAS: Wereda[] = [
  ...
  { id: 'wr_dab_01',  name: 'Dabe 01',     subCityId: 'sc_dabe' },
  { id: 'wr_dab_02',  name: 'Dabe 02',     subCityId: 'sc_dabe' },
  { id: 'wr_lug_01',  name: 'Lugo 01',     subCityId: 'sc_lugo' },
  { id: 'wr_lug_02',  name: 'Lugo 02',     subCityId: 'sc_lugo' },
  { id: 'wr_bol_01',  name: 'Bole 01',     subCityId: 'sc_bole' },
  { id: 'wr_bol_02',  name: 'Bole 02',     subCityId: 'sc_bole' },
  { id: 'wr_aba_01',  name: 'Aba-geda 01', subCityId: 'sc_abageda' },
  { id: 'wr_aba_02',  name: 'Aba-geda 02', subCityId: 'sc_abageda' },
];
...
export const AGREEMENTS: Agreement[] = [
  ...
  },
  {
    ...
    weredaId: 'wr_dab_01', subCityId: 'sc_dabe',
  ...
  },
  {
    ...
    buildingName: 'Wolde Hotel & Suites', address: 'Lugo 01, Tourism Zone',
    buildingFloors: 8, buildingType: 'Hospitality', tier: 'city',
    weredaId: 'wr_lug_01', subCityId: 'sc_lugo',
  ...
  },
  {
    ...
    buildingName: 'Solomon Family Home', address: 'Dabe 02, Residential Estate',
    buildingFloors: 2, buildingType: 'Residential', tier: 'wereda',
    weredaId: 'wr_dab_02', subCityId: 'sc_dabe',
  ...
  },
  {
    ...
    buildingName: 'Kebede Business Park', address: 'Aba-geda 01, Industrial Area',
    buildingFloors: 4, buildingType: 'Industrial', tier: 'subcity',
    weredaId: 'wr_aba_01', subCityId: 'sc_abageda',
  ...
  },
  {
    ...
    buildingName: 'Alemu Mall', address: 'Bole 01, Commercial Hub',
    buildingFloors: 3, buildingType: 'Commercial', tier: 'subcity',
    weredaId: 'wr_bol_01', subCityId: 'sc_bole',
...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    title: 'Dabe Sub-City Market Infrastructure',
    subCityId: 'sc_dabe',
    status: 'planning',
    ...
    budget: 22000000,
    spent: 0,
    description: 'New modern market facility to replace the aging structure in Dabe sub-city. Will include 200+ vendor stalls, cold storage, and parking.',
    reports: [],
    documents: [
...
export const PROFESSIONALS: Professional[] = [
  ...
  },
  {
    ...
    subCityId: 'sc_dabe', status: 'active',
  ...
  },
  {
    ...
    firmName: 'Aba-geda Project Advisory', grade: 'grade_2',
    subCityId: 'sc_abageda', status: 'active',
    issuedDate: '2022-06-30', expiryDate: '2025-12-30',
    phone: '+251 955 209 384', email: 'bethlehem.a@abagedaadvisory.et',
  ...
  },
  {
    ...
    subCityId: 'sc_lugo', status: 'expired',
  ...
  },
  {
    ...
    firmName: 'Bole Electromechanical', grade: 'grade_3',
    subCityId: 'sc_bole', status: 'pending_renewal',
    issuedDate: '2024-03-11', expiryDate: '2026-03-11',
    phone: '+251 900 477 238', email: 'tewodros.a@boleelectro.et',
